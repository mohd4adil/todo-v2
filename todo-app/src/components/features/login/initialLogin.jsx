...
const InitialLogin = ({handleForgotPassword, handleInitialCheck, handleGoogleLogin, setEmail, isSubmitting, isSubmittingGoogle}) => {
        ...
        <Card className="w-[400px] h-auto ml-16">
            ...
            <CardFooter className="flex flex-col">
                ...
                <div className="flex flex-col space-y-6 w-full">
                    <Button onClick={()=>handleInitialCheck()} disabled={isSubmitting} >
                    {isSubmitting ?
